...
#define BOARD_2944UW       3 /* AHA-2944 Ultra Wide, differential */
#define BOARD_2940         4 /* AHA-2940, narrow, on an AIC-7870 */
#define BOARD_2940W        5 /* AHA-2940W, the same card strapped wide */
...
aic_init(const device_t *info)
{
    ...
    /* The card's own BIOS. Every one of these images is an AHA-2940
       ...
       card does, or an AHA-2940 BIOS naming 9004:7178, or the 2944UW's
       own; the PCI BIOS refuses to run one whose ID does not match.
